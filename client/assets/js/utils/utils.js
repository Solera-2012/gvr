var utils = (function() {
  ...
  var extract_params = function(params_string) {
    console.log("Extract params of " + params_string);
    var params = {};
    ...
    request: function(api_stub, success_callback, error_callback, callback_params) {
      ...
      x.onreadystatechange = function() {
        ...
        if (x.readyState == XMLHttpRequest.DONE) {
          if (x.status == 200) {
            controllers[success_callback](x.responseText, callback_params);
          } else {
            controllers[error_callback](x.status, callback_params);
          }
        }
      };
